...
class Newinvoice extends React.Component {
  ...
  constructor(props) {
     ...
     url= "http://35.154.129.58:3001/sales/dependencies/e3152784-4811-4f2e-9a4f-884f3439db90/";
     this.state = {
       posts: [],
       accounts: [],
       salesheads:[]
...
axios.post('http://35.154.129.58:3001/sales/e3152784-4811-4f2e-9a4f-884f3439db90/invoices',{Date:date,Customer:{UID:customer},Lines:klk})
