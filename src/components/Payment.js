...
axios.post('http://35.154.129.58:3001/media/e3152784-4811-4f2e-9a4f-884f3439db90/customerPayments',{DepositTo:"Account",PaymentMethod:type,Account:{UID:"ff5fccac-6897-425e-87fd-dbb474c542f4"},Customer:{UID:cuid},Invoices:[{UID:ids,AmountApplied:k,Type:"Invoice"}]})
  .then(function (response) {
    ...
    if(x==k)
    {
     ...
     window.location.assign('/payment?id='+ids+'&&name='+nameid);
     }
  })
		...
		this.setState ( { loaded: false});
         ...
         axios.all([
                 ...
                 axios.get('http://35.154.129.58:3001/sales/dependencies/e3152784-4811-4f2e-9a4f-884f3439db90/'),
                  axios.get('http://35.154.129.58:3001/media/e3152784-4811-4f2e-9a4f-884f3439db90/customerPayments/'+nameid+'/'+ids)
